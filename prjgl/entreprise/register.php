                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="shop_name" class="control-label">Enreprise Name</label>
                                <input type="text" id="shop_name" autofocus name="shop_name" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">Enreprise Fullname</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">Stage Type</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="logo" class="control-label">Enreprise Logo</label>
